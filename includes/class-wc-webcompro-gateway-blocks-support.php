...
final class Webcompro_Gateway_Blocks_Support extends AbstractPaymentMethodType
{

	private $gateway;

	protected $name = 'webcompro'; // payment gateway id
	...
	{
		wp_register_script(
			'wc-webcompro-blocks-integration',
		...
		return array('wc-webcompro-blocks-integration');
	}
	...
	public function get_payment_method_data()
	{
		return array(
			...
			"nonce" => wp_create_nonce("wc_create_order"),
